...
English | [简体中文](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/README_zh-CN.md)
...
>Taking  `Translation Text`  as key is the key to all the functions of the library. If you have any questions about this, [Please see](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/Q&A.md)
...
An example of parsing text using  [Matching Rules](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/MATCH_RULE.md)  is as follows:
```js
/** Normal string */
...
* [Quick Start](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/USAGE.md)
* [Command Line](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/COMMAND_LINE.md)
* [API](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/API.md)
* [Matching Rules](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/MATCH_RULE.md)
* [Translation log](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/OUTPUT_LOG.md)
* [Q&A](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/Q&A.md)
* [Contribution Guidelines](https://github.com/i18n-pro/core/blob/dev/docs/dist/CONTRIBUTION_GUIDELINES.md)
* [Changelog](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/CHANGELOG.md)
