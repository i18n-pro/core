...
## 3. 初始化命令行配置文件
在命令行终端输入如下命令，[更多命令](https://github.com/i18n-pro/core/blob/v3.0.0-alpha.0/docs/dist/COMMAND_LINE_zh-CN.md#命令列表)
```bash
npx i18n init 
```
...
## 4. 调整 `i18nrc.ts` 配置
根据需求自行调整配置文件中的配置项，配置项的[说明](https://github.com/i18n-pro/core/blob/v3.0.0-alpha.0/docs/dist/COMMAND_LINE_zh-CN.md#1--i18nrcts-配置)
...
* 真实示例请参考  [Live Demo](https://github.com/i18n-pro/core/blob/v3.0.0-alpha.0/README_zh-CN.md#live-demo) 
