...
Enter the following command at the command line terminal, [more commands](https://github.com/i18n-pro/core/blob/v2.0.0-alpha.7/docs/dist/COMMAND_LINE.md#command-list)
```bash
npx i18n init 
```
...
Adjust the configuration items in the configuration file according to the requirements, [Description](https://github.com/i18n-pro/core/blob/v2.0.0-alpha.7/docs/dist/COMMAND_LINE.md#1--i18nrcjs--configuration) of configuration items
