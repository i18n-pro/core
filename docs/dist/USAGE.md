...
Enter the following command at the command line terminal, [more commands](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/COMMAND_LINE.md#command-list)
```bash
npx i18n init 
```
...
Adjust the configuration items in the configuration file according to the requirements, [Description](https://github.com/i18n-pro/core/blob/v2.1.0-alpha.1/docs/dist/COMMAND_LINE.md#1--i18nrcjs--configuration) of configuration items
...
## 8. Demo
Real code examples can be found in the  [Live Demo](https://github.com/i18n-pro/core/tree/v2.1.0-alpha.1#live-demo)  section of the  `README`  documentation, and the console output of the current library  `Command Line Tool`  has also been internationalized
