...
Enter the following command at the command line terminal, [more commands](https://github.com/i18n-pro/core/blob/v3.0.0-alpha.2/docs/dist/COMMAND_LINE.md#command-list)
```bash
npx i18n init 
```
...
Adjust the configuration items in the configuration file according to the requirements, [Description](https://github.com/i18n-pro/core/blob/v3.0.0-alpha.2/docs/dist/COMMAND_LINE.md#1--i18nrcts--configuration) of configuration items
...
* Please refer to  [Live Demo](https://github.com/i18n-pro/core/tree/v3.0.0-alpha.2#live-demo)  for real examples
