...
| setI18N  | (<br/>&nbsp;&nbsp;&nbsp;&nbsp;props: {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;locale?: string,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;langs?: Record<strng, Record<string, string>>,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;beginIndex?: number,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatNumber?: [FormatFunc](#fortmatfunc),<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatCurrency?: [FormatFunc](#fortmatfunc),<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatDate?: [FormatFunc](#fortmatfunc),<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatTime?: [FormatFunc](#fortmatfunc),<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formaPlural?: [FormatPluralFunc](#formatpluralfunc),<br/>&nbsp;&nbsp;&nbsp;&nbsp;}<br/>) => void | 设置语言和语言包<br/><br/> **locale**：指定当前语言<br/>**langs**：设置当前语言包<br/>**beginIndex**：设置 `i18n` 函数中动态参数起始下标，默认为0<br/>**formatNumber**：格式化数字类型动态参数的回调，对应的类型标记是 **n** 或 **N**，<br/>**formatCurrency**：格式化货币类型动态参数的回调，对应的类型标记是 **c** 或 **C**<br/>**formatDate**：格式化日期类型动态参数的回调，对应的类型标记是 **d** 或 **D**<br/>**formatTime**：格式化时间类型动态参数的回调，对应的类型标记是 **t** 或 **T**<br/>**formatPlural**：格式化复数类型动态参数的回调，对应的类型标记是 **p** 或 **P**<br/><br/>📢📢📢：`locale` 的值默认跟语言代码相对应，如需自定义，需参考 `codeLocaleMap` 的用法<br/>                                                                                                                                                                                                                            |
...
type FormatFunc = (props:{
  locale: string, // 当前语言
  payload: string | number | unknow, // 动态参数
}) => number | string
```
## FormatPluralFunc
复数的格式化回调函数类型
