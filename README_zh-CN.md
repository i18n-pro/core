...
[English](https://github.com/eyelly-wu/i18n-pro/tree/v2.0.0-alpha.3#readme) | 简体中文
...
>以 `翻译文案` 作为key是该库所有功能实现的关键，如果对此有任何疑问，[请查看](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/Q&A_zh-CN.md)
...
解析文案的 [匹配规则](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/MATCH_RULE_zh-CN.md) 简易示例如下
```js
/** 普通字符串 */
...
* [快速上手](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/USAGE_zh-CN.md)
* [命令行](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/COMMAND_LINE_zh-CN.md)
* [API](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/API_zh-CN.md)
* [匹配规则](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/MATCH_RULE_zh-CN.md)
* [翻译日志](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/OUTPUT_LOG_zh-CN.md)
* [Q&A](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/Q&A_zh-CN.md)
* [更新日志](https://github.com/eyelly-wu/i18n-pro/blob/v2.0.0-alpha.3/docs/dist/CHANGELOG_zh-CN.md)
