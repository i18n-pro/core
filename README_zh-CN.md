...
[English](https://github.com/i18n-pro/core/tree/v3.0.0#readme) | 简体中文
...
>  `自动翻译` 是当前库的核心特性之一，[了解更多](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/Q&A_zh-CN.md)<br/>
...
解析文案的 [匹配规则](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/MATCH_RULE_zh-CN.md) 简易示例如下
...
* [🚀 快速上手](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/USAGE_zh-CN.md)
* [💻 命令行](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/COMMAND_LINE_zh-CN.md)
* [📖 API](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/API_zh-CN.md)
...
* [❓ 问与答](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/Q&A_zh-CN.md)
* [🤝 贡献指南](https://github.com/i18n-pro/core/blob/dev/docs/dist/CONTRIBUTION_GUIDELINES_zh-CN.md)
* [📋 更新日志](https://github.com/i18n-pro/core/blob/v3.0.0/docs/dist/CHANGELOG_zh-CN.md)
